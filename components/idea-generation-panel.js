(function(){
  ...
  polymer_ext({
    ...
    ready: async function(){
      var self, all_goals, goal_info_list, sites_list, enabled_goals, enabled_goals_keys, enabled_spend_less_site, i$, len$, item, logging_server_url, site, site_upper, request, data, idea_temp, j$, len1$, ref$, site_ideas_pair, ref1$, site_counter_pair, index, this$ = this;
      self = this;
      ...
      return console.log(self.site_ideas_mapping_counter);
      function fn$(it){
        return it.json();
      }
    }
